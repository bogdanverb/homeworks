...
void show_final_cost() {
    ...
    printf("ставте  5 якщо пукiн гей\n");
    cout << Bottom << endl; // Стоимость коммунальных услуг составляет:
    cout << FinalCost << " " << Uah << endl;
    cout << setw(15) << setprecision(4)  << "Комиссия: " << float(ceil(FinalCost)) * 0.005 << " " << Uah << " (0.5%)" << endl; // Пример хардкода
